...
namespace k8s.Models
{
    ...
    public partial class V1Lifecycle
    {
        ...
        /// contention, etc. The handler is not called if the container crashes
        /// or exits. The reason for termination is passed to the handler. The
        /// Pod's termination grace period countdown begins before the PreStop
        /// hooked is executed. Regardless of the outcome of the handler, the
