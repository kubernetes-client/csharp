...
namespace k8s.Models
{
    ...
    public partial class V1beta2Subject
    {
        ...
        /// </param>
        public V1beta2Subject(string kind, V1beta2GroupSubject group = null, V1beta2ServiceAccountSubject serviceAccount = null, V1beta2UserSubject user = null)
        {
            Group = group;
            Kind = kind;
        ...
        public V1beta2GroupSubject Group { get; set; }
        ...
        public V1beta2ServiceAccountSubject ServiceAccount { get; set; }

        /// <summary>
        /// `user` matches based on username.
        /// </summary>
        [JsonPropertyName("user")]
        public V1beta2UserSubject User { get; set; }
