...
namespace k8s.Models
{
    ...
    public partial class V1CSIVolumeSource
    {
        ...
        /// Initializes a new instance of the V1CSIVolumeSource class.
        /// </summary>
        /// <param name="driver">Driver is the name of the CSI driver that
        /// handles this volume. Consult with your admin for the correct name
        /// as registered in the cluster.</param>
        /// <param name="fsType">Filesystem type to mount. Ex. "ext4", "xfs",
        ...
        /// than one secret, all secret references are passed.</param>
        /// <param name="readOnlyProperty">Specifies a read-only configuration
        /// for the volume. Defaults to false (read/write).</param>
        /// <param name="volumeAttributes">VolumeAttributes stores
        /// driver-specific properties that are passed to the CSI driver.
        /// Consult your driver's documentation for supported values.</param>
        public V1CSIVolumeSource(string driver, string fsType = default(string), V1LocalObjectReference nodePublishSecretRef = default(V1LocalObjectReference), bool? readOnlyProperty = default(bool?), IDictionary<string, string> volumeAttributes = default(IDictionary<string, string>))
        {
            Driver = driver;
            FsType = fsType;
        ...
        /// <summary>
        /// Gets or sets driver is the name of the CSI driver that handles this
        ...
        /// <summary>
        /// Gets or sets filesystem type to mount. Ex. "ext4", "xfs", "ntfs".
        ...
        /// <summary>
        /// Gets or sets volumeAttributes stores driver-specific properties
