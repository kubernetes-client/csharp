...
namespace k8s.Models
{
    ...
    public partial class V2HorizontalPodAutoscalerSpec
    {
        ...
        /// value is available.
        /// </param>
        public V2HorizontalPodAutoscalerSpec(int maxReplicas, V2CrossVersionObjectReference scaleTargetRef, V2HorizontalPodAutoscalerBehavior behavior = null, IList<V2MetricSpec> metrics = null, int? minReplicas = null)
        {
            Behavior = behavior;
