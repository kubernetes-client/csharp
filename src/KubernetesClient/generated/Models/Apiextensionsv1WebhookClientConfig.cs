...
namespace k8s.Models
{
    ...
    public partial class Apiextensionsv1WebhookClientConfig
    {
        ...
        public Apiextensionsv1WebhookClientConfig(byte[] caBundle = default(byte[]), Apiextensionsv1ServiceReference service = default(Apiextensionsv1ServiceReference), string url = default(string))
        {
            CaBundle = caBundle;
            Service = service;
            Url = url;
