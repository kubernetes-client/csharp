...
namespace k8s.Models
{
    ...
    public partial class V1ValidatingWebhookConfigurationList
    {
        ...
        /// https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</param>
        public V1ValidatingWebhookConfigurationList(IList<V1ValidatingWebhookConfiguration> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
