...
namespace k8s.Models
{
    ...
    public partial class V1VolumeAttachment
    {
        ...
        /// </param>
        public V1VolumeAttachment(V1VolumeAttachmentSpec spec, string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V1VolumeAttachmentStatus status = null)
        {
