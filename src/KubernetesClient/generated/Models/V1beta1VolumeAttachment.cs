...
namespace k8s.Models
{
    ...
    public partial class V1beta1VolumeAttachment
    {
        ...
        /// </param>
        public V1beta1VolumeAttachment(V1beta1VolumeAttachmentSpec spec, string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V1beta1VolumeAttachmentStatus status = null)
        {
