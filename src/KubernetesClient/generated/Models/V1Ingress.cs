...
namespace k8s.Models
{
    ...
    public partial class V1Ingress
    {
        ...
        /// More info:
        /// https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status</param>
        public V1Ingress(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), V1IngressSpec spec = default(V1IngressSpec), V1IngressStatus status = default(V1IngressStatus))
        {
