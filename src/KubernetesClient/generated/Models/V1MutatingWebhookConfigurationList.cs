...
namespace k8s.Models
{
    ...
    public partial class V1MutatingWebhookConfigurationList
    {
        ...
        /// https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</param>
        public V1MutatingWebhookConfigurationList(IList<V1MutatingWebhookConfiguration> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1MutatingWebhookConfiguration> Items { get; set; }
