...
namespace k8s.Models
{
    ...
    public partial class V1CSINodeList
    {
        ...
        public V1CSINodeList(IList<V1CSINode> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1CSINode> Items { get; set; }
