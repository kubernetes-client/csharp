...
namespace k8s.Models
{
    ...
    public partial class V1beta1ResourceAttributes
    {
        ...
        /// </param>
        public V1beta1ResourceAttributes(string group = null, string name = null, string namespaceProperty = null, string resource = null, string subresource = null, string verb = null, string version = null)
        {
            Group = group;
            Name = name;
