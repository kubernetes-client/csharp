...
namespace k8s.Models
{
    ...
    public partial class V1ClusterRole
    {
        ...
        /// ClusterRole</param>
        public V1ClusterRole(V1AggregationRule aggregationRule = default(V1AggregationRule), string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IList<V1PolicyRule> rules = default(IList<V1PolicyRule>))
        {
