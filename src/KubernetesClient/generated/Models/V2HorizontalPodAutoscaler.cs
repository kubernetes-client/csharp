...
namespace k8s.Models
{
    ...
    public partial class V2HorizontalPodAutoscaler
    {
        ...
        /// </param>
        public V2HorizontalPodAutoscaler(string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V2HorizontalPodAutoscalerSpec spec = null, V2HorizontalPodAutoscalerStatus status = null)
        {
