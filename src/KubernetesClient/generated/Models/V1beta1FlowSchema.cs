...
namespace k8s.Models
{
    ...
    public partial class V1beta1FlowSchema
    {
        ...
        /// https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        /// </param>
        public V1beta1FlowSchema(string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V1beta1FlowSchemaSpec spec = null, V1beta1FlowSchemaStatus status = null)
        {
