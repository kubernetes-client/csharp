...
namespace k8s.Models
{
    ...
    public partial class V1beta1MutatingWebhook
    {
        ...
        /// seconds.
        /// </param>
        public V1beta1MutatingWebhook(Admissionregistrationv1beta1WebhookClientConfig clientConfig, string name, IList<string> admissionReviewVersions = null, string failurePolicy = null, string matchPolicy = null, V1LabelSelector namespaceSelector = null, V1LabelSelector objectSelector = null, string reinvocationPolicy = null, IList<V1beta1RuleWithOperations> rules = null, string sideEffects = null, int? timeoutSeconds = null)
        {
