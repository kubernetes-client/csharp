...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V1IngressList
    {
        /// <summary>
        ...
        public V1IngressList(IList<V1Ingress> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1Ingress> Items { get; set; }
