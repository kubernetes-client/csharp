...
namespace k8s.Models
{
    ...
    public partial class V1alpha1FlowSchemaSpec
    {
        ...
        /// MatchingPrecedence value must be non-negative. Note that if the
        /// precedence is not specified or zero, it will be set to 1000 as
        /// default.</param>
        ...
        /// value must be non-negative. Note that if the precedence is not
        /// specified or zero, it will be set to 1000 as default.
        /// </summary>
