...
namespace k8s.Models
{
    ...
    public partial class V1RBDPersistentVolumeSource
    {
        ...
        /// https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it
        /// </param>
        public V1RBDPersistentVolumeSource(string image, IList<string> monitors, string fsType = null, string keyring = null, string pool = null, bool? readOnlyProperty = null, V1SecretReference secretRef = null, string user = null)
        {
            FsType = fsType;
            Image = image;
            Keyring = keyring;
