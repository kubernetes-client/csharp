...
namespace k8s.Models
{
    ...
    public partial class V1PriorityClassList
    {
        ...
        public V1PriorityClassList(IList<V1PriorityClass> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1PriorityClass> Items { get; set; }
