...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1RunAsGroupStrategyOptions
        /// class.
        /// </summary>
        ...
        /// MustRunAs.</param>
        public V1beta1RunAsGroupStrategyOptions(string rule, IList<V1beta1IDRange> ranges = default(IList<V1beta1IDRange>))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
