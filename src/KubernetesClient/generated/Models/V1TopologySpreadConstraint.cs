...
namespace k8s.Models
{
    ...
    public partial class V1TopologySpreadConstraint
    {
        ...
        /// unevenly distributed. When `whenUnsatisfiable=DoNotSchedule`, it is
        /// the maximum permitted difference between the number of matching
        /// pods in the target topology and the global minimum. For example, in
        /// a 3-zone cluster, MaxSkew is set to 1, and pods with the same
        /// labelSelector spread as 1/1/0: | zone1 | zone2 | zone3 | |   P   |
        /// P   |       | - if MaxSkew is 1, incoming pod can only be scheduled
        /// to zone3 to become 1/1/1; scheduling it onto zone1(zone2) would
        /// make the ActualSkew(2-0) on zone1(zone2) violate MaxSkew(1). - if
