...
namespace k8s.Models
{
    ...
    public partial class V1ReplicationController
    {
        ...
        /// https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
        /// </param>
        public V1ReplicationController(string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V1ReplicationControllerSpec spec = null, V1ReplicationControllerStatus status = null)
        {
