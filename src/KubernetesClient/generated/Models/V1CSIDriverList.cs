...
namespace k8s.Models
{
    ...
    public partial class V1CSIDriverList
    {
        ...
        public V1CSIDriverList(IList<V1CSIDriver> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<V1CSIDriver> Items { get; set; }
