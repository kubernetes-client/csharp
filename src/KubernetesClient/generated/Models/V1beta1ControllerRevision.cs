...
namespace k8s.Models
{
    ...
    public partial class V1beta1ControllerRevision
    {
        ...
        public V1beta1ControllerRevision(long revision, string apiVersion = default(string), object data = default(object), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
