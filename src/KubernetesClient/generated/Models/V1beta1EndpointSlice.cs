...
namespace k8s.Models
{
    ...
    public partial class V1beta1EndpointSlice
    {
        ...
        /// ports.</param>
        public V1beta1EndpointSlice(string addressType, IList<V1beta1Endpoint> endpoints, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IList<V1beta1EndpointPort> ports = default(IList<V1beta1EndpointPort>))
        {
