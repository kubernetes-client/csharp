...
namespace k8s.Models
{
    ...
    public partial class V1ValidatingWebhook
    {
        ...
        /// seconds.</param>
        public V1ValidatingWebhook(IList<string> admissionReviewVersions, Admissionregistrationv1WebhookClientConfig clientConfig, string name, string sideEffects, string failurePolicy = default(string), string matchPolicy = default(string), V1LabelSelector namespaceSelector = default(V1LabelSelector), V1LabelSelector objectSelector = default(V1LabelSelector), IList<V1RuleWithOperations> rules = default(IList<V1RuleWithOperations>), int? timeoutSeconds = default(int?))
        {
