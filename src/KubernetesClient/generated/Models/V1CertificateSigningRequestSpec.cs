...
namespace k8s.Models
{
    ...
    public partial class V1CertificateSigningRequestSpec
    {
        ...
        /// immutable.
        /// </param>
        public V1CertificateSigningRequestSpec(byte[] request, string signerName, IDictionary<string, IList<string>> extra = null, IList<string> groups = null, string uid = null, IList<string> usages = null, string username = null)
        {
            Extra = extra;
            Groups = groups;
            Request = request;
