...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1MutatingWebhookConfiguration
        /// class.
        /// </summary>
        ...
        public V1MutatingWebhookConfiguration(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IList<V1MutatingWebhook> webhooks = default(IList<V1MutatingWebhook>))
        {
