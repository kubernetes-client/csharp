...
namespace k8s.Models
{
    ...
    public partial class V1alpha1VolumeAttachment
    {
        ...
        /// </param>
        public V1alpha1VolumeAttachment(V1alpha1VolumeAttachmentSpec spec, string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, V1alpha1VolumeAttachmentStatus status = null)
        {
