...
namespace k8s.Models
{
    ...
    public partial class V1Endpoint
    {
        ...
        /// </param>
        public V1Endpoint(IList<string> addresses, V1EndpointConditions conditions = null, IDictionary<string, string> deprecatedTopology = null, V1EndpointHints hints = null, string hostname = null, string nodeName = null, V1ObjectReference targetRef = null, string zone = null)
        {
            Addresses = addresses;
