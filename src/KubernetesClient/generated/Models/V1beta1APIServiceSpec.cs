...
namespace k8s.Models
{
    ...
    public partial class V1beta1APIServiceSpec
    {
        ...
        public V1beta1APIServiceSpec(int groupPriorityMinimum, int versionPriority, byte[] caBundle = default(byte[]), string group = default(string), bool? insecureSkipTLSVerify = default(bool?), Apiregistrationv1beta1ServiceReference service = default(Apiregistrationv1beta1ServiceReference), string version = default(string))
        {
            CaBundle = caBundle;
            Group = group;
