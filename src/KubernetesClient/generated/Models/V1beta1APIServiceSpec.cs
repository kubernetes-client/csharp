...
namespace k8s.Models
{
    ...
    public partial class V1beta1APIServiceSpec
    {
        ...
        /// </param>
        public V1beta1APIServiceSpec(int groupPriorityMinimum, int versionPriority, byte[] caBundle = null, string group = null, bool? insecureSkipTLSVerify = null, Apiregistrationv1beta1ServiceReference service = null, string version = null)
        {
            CaBundle = caBundle;
            Group = group;
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "GroupPriorityMinimum");    
            }
            if (VersionPriority == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "VersionPriority");    
            }
            Service?.Validate();
        }
    }
