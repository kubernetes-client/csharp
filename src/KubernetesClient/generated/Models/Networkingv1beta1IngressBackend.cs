...
namespace k8s.Models
{
    ...
    public partial class Networkingv1beta1IngressBackend
    {
        ...
        /// service.</param>
        public Networkingv1beta1IngressBackend(V1TypedLocalObjectReference resource = default(V1TypedLocalObjectReference), string serviceName = default(string), string servicePort = default(string))
        {
            Resource = resource;
