...
namespace k8s.Models
{
    ...
    public partial class V1ResourceAttributes
    {
        ...
        /// "*" means all.</param>
        public V1ResourceAttributes(string group = default(string), string name = default(string), string namespaceProperty = default(string), string resource = default(string), string subresource = default(string), string verb = default(string), string version = default(string))
        {
            Group = group;
            Name = name;
