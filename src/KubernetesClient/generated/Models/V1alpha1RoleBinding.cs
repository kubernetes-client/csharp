...
namespace k8s.Models
{
    ...
    public partial class V1alpha1RoleBinding
    {
        ...
        /// </param>
        public V1alpha1RoleBinding(V1alpha1RoleRef roleRef, string apiVersion = null, string kind = null, V1ObjectMeta metadata = null, IList<V1alpha1Subject> subjects = null)
        {
