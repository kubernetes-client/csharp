...
namespace k8s.Models
{
    ...
    public partial class V1SubjectAccessReviewSpec
    {
        ...
        public V1SubjectAccessReviewSpec(IDictionary<string, IList<string>> extra = default(IDictionary<string, IList<string>>), IList<string> groups = default(IList<string>), V1NonResourceAttributes nonResourceAttributes = default(V1NonResourceAttributes), V1ResourceAttributes resourceAttributes = default(V1ResourceAttributes), string uid = default(string), string user = default(string))
        {
            Extra = extra;
            Groups = groups;
