...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1Probe
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Probe class.
        /// </summary>
        public Corev1Probe()
        {
            CustomInit();
        ...
        /// info:
        /// https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes</param>
        public Corev1Probe(Corev1ExecAction exec = default(Corev1ExecAction), int? failureThreshold = default(int?), Corev1HTTPGetAction httpGet = default(Corev1HTTPGetAction), int? initialDelaySeconds = default(int?), int? periodSeconds = default(int?), int? successThreshold = default(int?), Corev1TCPSocketAction tcpSocket = default(Corev1TCPSocketAction), int? timeoutSeconds = default(int?))
        {
            Exec = exec;
