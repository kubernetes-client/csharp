...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1IDRange
    {
        /// <summary>
        /// Initializes a new instance of the Apiextensionsv1beta1IDRange
        /// class.
        /// </summary>
        public Apiextensionsv1beta1IDRange()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1IDRange(long max, long min)
        {
            Max = max;
            Min = min;
            CustomInit();
