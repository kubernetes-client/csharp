...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1HostPathVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1HostPathVolumeSource class.
        /// </summary>
        public Corev1HostPathVolumeSource()
        {
            CustomInit();
        }
        ...
        /// info:
        /// https://kubernetes.io/docs/concepts/storage/volumes#hostpath</param>
        public Corev1HostPathVolumeSource(string path, string type = default(string))
        {
            Path = path;
            Type = type;
            CustomInit();
