...
namespace k8s.Models
{
    ...
    /// controller.
    /// </summary>
    public partial class Corev1ReplicationController
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ReplicationController
        /// class.
        /// </summary>
        public Corev1ReplicationController()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public Corev1ReplicationController(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Corev1ReplicationControllerSpec spec = default(Corev1ReplicationControllerSpec), Corev1ReplicationControllerStatus status = default(Corev1ReplicationControllerStatus))
        {
        ...
        public Corev1ReplicationControllerSpec Spec { get; set; }
        ...
        public Corev1ReplicationControllerStatus Status { get; set; }
