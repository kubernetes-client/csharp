...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1NodeAddress
    {
        /// <summary>
        /// Initializes a new instance of the Corev1NodeAddress class.
        /// </summary>
        public Corev1NodeAddress()
        {
            CustomInit();
        }
        ...
        /// or InternalIP.</param>
        public Corev1NodeAddress(string address, string type)
        {
            Address = address;
            Type = type;
            CustomInit();
