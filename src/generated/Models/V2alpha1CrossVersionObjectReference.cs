...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V2alpha1CrossVersionObjectReference
    {
        /// <summary>
        /// Initializes a new instance of the
        /// V2alpha1CrossVersionObjectReference class.
        /// </summary>
        public V2alpha1CrossVersionObjectReference()
        {
          CustomInit();
        }
        ...
        public V2alpha1CrossVersionObjectReference(string kind, string name, string apiVersion = default(string))
        {
