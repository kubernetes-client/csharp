...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthorizationv1NonResourceAttributes
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthorizationv1NonResourceAttributes class.
        /// </summary>
        public Apiauthorizationv1NonResourceAttributes()
        {
            CustomInit();
        }
        ...
        public Apiauthorizationv1NonResourceAttributes(string path = default(string), string verb = default(string))
        {
            Path = path;
            Verb = verb;
            CustomInit();
