...
namespace k8s.Models
{
    ...
    /// user.Info interface.
    /// </summary>
    public partial class Apiauthenticationv1UserInfo
    {
        /// <summary>
        /// Initializes a new instance of the Apiauthenticationv1UserInfo
        /// class.
        /// </summary>
        public Apiauthenticationv1UserInfo()
        {
            CustomInit();
        }
        ...
        public Apiauthenticationv1UserInfo(IDictionary<string, IList<string>> extra = default(IDictionary<string, IList<string>>), IList<string> groups = default(IList<string>), string uid = default(string), string username = default(string))
        {
            Extra = extra;
            Groups = groups;
            Uid = uid;
