...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1SecretVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1SecretVolumeSource class.
        /// </summary>
        public Corev1SecretVolumeSource()
        {
            CustomInit();
        }
        ...
        public Corev1SecretVolumeSource(int? defaultMode = default(int?), IList<Corev1KeyToPath> items = default(IList<Corev1KeyToPath>), bool? optional = default(bool?), string secretName = default(string))
        {
