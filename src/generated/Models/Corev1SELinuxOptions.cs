...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1SELinuxOptions
    {
        /// <summary>
        /// Initializes a new instance of the Corev1SELinuxOptions class.
        /// </summary>
        public Corev1SELinuxOptions()
        {
            CustomInit();
        }
        ...
        /// container.</param>
        public Corev1SELinuxOptions(string level = default(string), string role = default(string), string type = default(string), string user = default(string))
        {
            Level = level;
            Role = role;
            Type = type;
