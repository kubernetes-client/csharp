...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PersistentVolume
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PersistentVolume class.
        /// </summary>
        public Corev1PersistentVolume()
        {
            CustomInit();
        }
        ...
        /// https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistent-volumes</param>
        public Corev1PersistentVolume(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Corev1PersistentVolumeSpec spec = default(Corev1PersistentVolumeSpec), Corev1PersistentVolumeStatus status = default(Corev1PersistentVolumeStatus))
        {
        ...
        public Corev1PersistentVolumeSpec Spec { get; set; }
        ...
        public Corev1PersistentVolumeStatus Status { get; set; }
