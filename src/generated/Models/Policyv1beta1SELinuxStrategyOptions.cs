...
namespace k8s.Models
{
    ...
    public partial class Policyv1beta1SELinuxStrategyOptions
    {
        ...
        /// </summary>
        public Policyv1beta1SELinuxStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Policyv1beta1SELinuxStrategyOptions(string rule, V1SELinuxOptions seLinuxOptions = default(V1SELinuxOptions))
        {
            Rule = rule;
