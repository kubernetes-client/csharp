...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1KeyToPath
    {
        /// <summary>
        /// Initializes a new instance of the Corev1KeyToPath class.
        /// </summary>
        public Corev1KeyToPath()
        {
            CustomInit();
        }
        ...
        public Corev1KeyToPath(string key, string path, int? mode = default(int?))
        {
            Key = key;
            Mode = mode;
            Path = path;
