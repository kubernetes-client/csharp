...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1Pod
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Pod class.
        /// </summary>
        public Corev1Pod()
        {
            CustomInit();
        ...
        /// More info:
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public Corev1Pod(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Corev1PodSpec spec = default(Corev1PodSpec), Corev1PodStatus status = default(Corev1PodStatus))
        {
        ...
        public Corev1PodStatus Status { get; set; }
