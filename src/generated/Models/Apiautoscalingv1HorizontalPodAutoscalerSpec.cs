...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiautoscalingv1HorizontalPodAutoscalerSpec
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiautoscalingv1HorizontalPodAutoscalerSpec class.
        /// </summary>
        public Apiautoscalingv1HorizontalPodAutoscalerSpec()
        {
            CustomInit();
        }
        ...
        /// used.</param>
        public Apiautoscalingv1HorizontalPodAutoscalerSpec(int maxReplicas, Apiautoscalingv1CrossVersionObjectReference scaleTargetRef, int? minReplicas = default(int?), int? targetCPUUtilizationPercentage = default(int?))
        {
        ...
        public Apiautoscalingv1CrossVersionObjectReference ScaleTargetRef { get; set; }
