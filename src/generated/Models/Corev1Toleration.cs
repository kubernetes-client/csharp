...
namespace k8s.Models
{
    ...
    /// &lt;operator&gt;.
    /// </summary>
    public partial class Corev1Toleration
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Toleration class.
        /// </summary>
        public Corev1Toleration()
        {
            CustomInit();
        }
        ...
        public Corev1Toleration(string effect = default(string), string key = default(string), string operatorProperty = default(string), long? tolerationSeconds = default(long?), string value = default(string))
        {
            Effect = effect;
            Key = key;
