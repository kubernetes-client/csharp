...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1ReplicationControllerCondition
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Corev1ReplicationControllerCondition class.
        /// </summary>
        public Corev1ReplicationControllerCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public Corev1ReplicationControllerCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
