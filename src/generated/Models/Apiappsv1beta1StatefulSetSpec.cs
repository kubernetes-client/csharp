...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiappsv1beta1StatefulSetSpec
    {
        /// <summary>
        /// Initializes a new instance of the Apiappsv1beta1StatefulSetSpec
        /// class.
        /// </summary>
        public Apiappsv1beta1StatefulSetSpec()
        {
            CustomInit();
        }
        ...
        public Apiappsv1beta1StatefulSetSpec(string serviceName, Corev1PodTemplateSpec template, string podManagementPolicy = default(string), int? replicas = default(int?), int? revisionHistoryLimit = default(int?), V1LabelSelector selector = default(V1LabelSelector), Apiappsv1beta1StatefulSetUpdateStrategy updateStrategy = default(Apiappsv1beta1StatefulSetUpdateStrategy), IList<Corev1PersistentVolumeClaim> volumeClaimTemplates = default(IList<Corev1PersistentVolumeClaim>))
        {
        ...
        public Apiappsv1beta1StatefulSetUpdateStrategy UpdateStrategy { get; set; }
