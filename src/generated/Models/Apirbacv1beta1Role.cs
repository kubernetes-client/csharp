...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1beta1Role
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1beta1Role class.
        /// </summary>
        public Apirbacv1beta1Role()
        {
            CustomInit();
        }
        ...
        public Apirbacv1beta1Role(IList<Apirbacv1beta1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
