...
namespace k8s.Models
{
    ...
    public partial class V1ObjectMeta
    {
        ...
        /// http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#idempotency</param>
        ...
        public V1ObjectMeta(IDictionary<string, string> annotations = default(IDictionary<string, string>), string clusterName = default(string), System.DateTime? creationTimestamp = default(System.DateTime?), long? deletionGracePeriodSeconds = default(long?), System.DateTime? deletionTimestamp = default(System.DateTime?), IList<string> finalizers = default(IList<string>), string generateName = default(string), long? generation = default(long?), IDictionary<string, string> labels = default(IDictionary<string, string>), string name = default(string), string namespaceProperty = default(string), IList<V1OwnerReference> ownerReferences = default(IList<V1OwnerReference>), string resourceVersion = default(string), string selfLink = default(string), string uid = default(string))
        {
