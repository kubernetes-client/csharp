...
namespace k8s.Models
{
    ...
    /// Ingress.
    /// </summary>
    public partial class Apiextensionsv1beta1IngressTLS
    {
        /// <summary>
        /// Initializes a new instance of the Apiextensionsv1beta1IngressTLS
        /// class.
        /// </summary>
        public Apiextensionsv1beta1IngressTLS()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1IngressTLS(IList<string> hosts = default(IList<string>), string secretName = default(string))
        {
            Hosts = hosts;
