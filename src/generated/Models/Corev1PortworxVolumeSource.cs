...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PortworxVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PortworxVolumeSource class.
        /// </summary>
        public Corev1PortworxVolumeSource()
        {
            CustomInit();
        }
        ...
        /// VolumeMounts.</param>
        public Corev1PortworxVolumeSource(string volumeID, string fsType = default(string), bool? readOnlyProperty = default(bool?))
        {
            FsType = fsType;
