...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthorizationv1beta1LocalSubjectAccessReview
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthorizationv1beta1LocalSubjectAccessReview class.
        /// </summary>
        public Apiauthorizationv1beta1LocalSubjectAccessReview()
        {
            CustomInit();
        }
        ...
        public Apiauthorizationv1beta1LocalSubjectAccessReview(Apiauthorizationv1beta1SubjectAccessReviewSpec spec, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Apiauthorizationv1beta1SubjectAccessReviewStatus status = default(Apiauthorizationv1beta1SubjectAccessReviewStatus))
        {
        ...
        public Apiauthorizationv1beta1SubjectAccessReviewSpec Spec { get; set; }
        ...
        public Apiauthorizationv1beta1SubjectAccessReviewStatus Status { get; set; }
