...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1SELinuxStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1SELinuxStrategyOptions class.
        /// </summary>
        public Apiextensionsv1beta1SELinuxStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1SELinuxStrategyOptions(string rule, Corev1SELinuxOptions seLinuxOptions = default(Corev1SELinuxOptions))
        {
            Rule = rule;
