...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthorizationv1beta1SelfSubjectAccessReview
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthorizationv1beta1SelfSubjectAccessReview class.
        /// </summary>
        public Apiauthorizationv1beta1SelfSubjectAccessReview()
        {
            CustomInit();
        }
        ...
        public Apiauthorizationv1beta1SelfSubjectAccessReview(Apiauthorizationv1beta1SelfSubjectAccessReviewSpec spec, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Apiauthorizationv1beta1SubjectAccessReviewStatus status = default(Apiauthorizationv1beta1SubjectAccessReviewStatus))
        {
        ...
        public Apiauthorizationv1beta1SelfSubjectAccessReviewSpec Spec { get; set; }
