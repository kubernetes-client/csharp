...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1LimitRangeList
    {
        /// <summary>
        /// Initializes a new instance of the Corev1LimitRangeList class.
        /// </summary>
        public Corev1LimitRangeList()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public Corev1LimitRangeList(IList<Corev1LimitRange> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<Corev1LimitRange> Items { get; set; }
