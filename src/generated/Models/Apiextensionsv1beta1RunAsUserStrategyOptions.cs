...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1RunAsUserStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1RunAsUserStrategyOptions class.
        /// </summary>
        public Apiextensionsv1beta1RunAsUserStrategyOptions()
        {
            CustomInit();
        }
        ...
        /// be used.</param>
        public Apiextensionsv1beta1RunAsUserStrategyOptions(string rule, IList<Apiextensionsv1beta1IDRange> ranges = default(IList<Apiextensionsv1beta1IDRange>))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
