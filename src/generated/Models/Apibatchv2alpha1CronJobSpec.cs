...
namespace k8s.Models
{
    ...
    /// will actually run.
    /// </summary>
    public partial class Apibatchv2alpha1CronJobSpec
    {
        /// <summary>
        /// Initializes a new instance of the Apibatchv2alpha1CronJobSpec
        /// class.
        /// </summary>
        public Apibatchv2alpha1CronJobSpec()
        {
            CustomInit();
        }
        ...
        public Apibatchv2alpha1CronJobSpec(Apibatchv2alpha1JobTemplateSpec jobTemplate, string schedule, string concurrencyPolicy = default(string), int? failedJobsHistoryLimit = default(int?), long? startingDeadlineSeconds = default(long?), int? successfulJobsHistoryLimit = default(int?), bool? suspend = default(bool?))
        {
        ...
        public Apibatchv2alpha1JobTemplateSpec JobTemplate { get; set; }
