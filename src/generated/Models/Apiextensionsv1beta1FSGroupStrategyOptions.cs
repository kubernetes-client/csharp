...
namespace k8s.Models
{
    ...
    /// create the strategy.
    /// </summary>
    public partial class Apiextensionsv1beta1FSGroupStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1FSGroupStrategyOptions class.
        /// </summary>
        public Apiextensionsv1beta1FSGroupStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1FSGroupStrategyOptions(IList<Apiextensionsv1beta1IDRange> ranges = default(IList<Apiextensionsv1beta1IDRange>), string rule = default(string))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
