...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1ReplicationControllerCondition
        /// class.
        /// </summary>
        ...
        /// transition.</param>
        public V1ReplicationControllerCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
