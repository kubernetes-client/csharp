...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1beta1ClusterRoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1beta1ClusterRoleBinding
        /// class.
        /// </summary>
        public Apirbacv1beta1ClusterRoleBinding()
        {
            CustomInit();
        }
        ...
        public Apirbacv1beta1ClusterRoleBinding(Apirbacv1beta1RoleRef roleRef, IList<Apirbacv1beta1Subject> subjects, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
