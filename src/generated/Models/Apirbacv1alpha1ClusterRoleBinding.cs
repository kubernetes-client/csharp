...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1alpha1ClusterRoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1alpha1ClusterRoleBinding
        /// class.
        /// </summary>
        public Apirbacv1alpha1ClusterRoleBinding()
        {
            CustomInit();
        }
        ...
        public Apirbacv1alpha1ClusterRoleBinding(Apirbacv1alpha1RoleRef roleRef, IList<Apirbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
        ...
        public Apirbacv1alpha1RoleRef RoleRef { get; set; }
        ...
        public IList<Apirbacv1alpha1Subject> Subjects { get; set; }
