...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiappsv1beta1ControllerRevision
    {
        /// <summary>
        /// Initializes a new instance of the Apiappsv1beta1ControllerRevision
        /// class.
        /// </summary>
        public Apiappsv1beta1ControllerRevision()
        {
            CustomInit();
        }
        ...
        public Apiappsv1beta1ControllerRevision(long revision, string apiVersion = default(string), RuntimeRawExtension data = default(RuntimeRawExtension), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
