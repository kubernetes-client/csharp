...
namespace k8s.Models
{
    ...
    /// controller.
    /// </summary>
    public partial class Corev1ReplicationControllerSpec
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ReplicationControllerSpec
        /// class.
        /// </summary>
        public Corev1ReplicationControllerSpec()
        {
            CustomInit();
        }
        ...
        public Corev1ReplicationControllerSpec(int? minReadySeconds = default(int?), int? replicas = default(int?), IDictionary<string, string> selector = default(IDictionary<string, string>), Corev1PodTemplateSpec template = default(Corev1PodTemplateSpec))
        {
