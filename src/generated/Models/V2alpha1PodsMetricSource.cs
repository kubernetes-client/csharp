...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V2alpha1PodsMetricSource
    {
        /// <summary>
        /// Initializes a new instance of the V2alpha1PodsMetricSource class.
        /// </summary>
        public V2alpha1PodsMetricSource()
        {
          CustomInit();
        }
        ...
        /// quantity)</param>
        public V2alpha1PodsMetricSource(string metricName, string targetAverageValue)
        {
