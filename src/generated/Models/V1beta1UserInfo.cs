...
namespace k8s.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the V1beta1UserInfo class.
        /// </summary>
        public V1beta1UserInfo()
        {
          CustomInit();
        }
        ...
        public V1beta1UserInfo(IDictionary<string, IList<string>> extra = default(IDictionary<string, IList<string>>), IList<string> groups = default(IList<string>), string uid = default(string), string username = default(string))
        {
            Extra = extra;
            Groups = groups;
            Uid = uid;
