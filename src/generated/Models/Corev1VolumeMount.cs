...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1VolumeMount
    {
        /// <summary>
        /// Initializes a new instance of the Corev1VolumeMount class.
        /// </summary>
        public Corev1VolumeMount()
        {
            CustomInit();
        }
        ...
        /// root).</param>
        public Corev1VolumeMount(string mountPath, string name, string mountPropagation = default(string), bool? readOnlyProperty = default(bool?), string subPath = default(string))
        {
            MountPath = mountPath;
