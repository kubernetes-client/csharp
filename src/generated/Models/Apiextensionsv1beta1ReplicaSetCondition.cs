...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class Apiextensionsv1beta1ReplicaSetCondition
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1ReplicaSetCondition class.
        /// </summary>
        public Apiextensionsv1beta1ReplicaSetCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public Apiextensionsv1beta1ReplicaSetCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
