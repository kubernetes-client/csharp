...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1ResourceQuotaList
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ResourceQuotaList class.
        /// </summary>
        public Corev1ResourceQuotaList()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public Corev1ResourceQuotaList(IList<Corev1ResourceQuota> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<Corev1ResourceQuota> Items { get; set; }
