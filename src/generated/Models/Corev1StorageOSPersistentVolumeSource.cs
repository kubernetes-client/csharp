...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1StorageOSPersistentVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Corev1StorageOSPersistentVolumeSource class.
        /// </summary>
        public Corev1StorageOSPersistentVolumeSource()
        {
            CustomInit();
        }
        ...
        /// created.</param>
        public Corev1StorageOSPersistentVolumeSource(string fsType = default(string), bool? readOnlyProperty = default(bool?), Corev1ObjectReference secretRef = default(Corev1ObjectReference), string volumeName = default(string), string volumeNamespace = default(string))
        {
            FsType = fsType;
        ...
        public Corev1ObjectReference SecretRef { get; set; }
