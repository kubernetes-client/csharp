...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1Ingress
    {
        /// <summary>
        /// Initializes a new instance of the Apiextensionsv1beta1Ingress
        /// class.
        /// </summary>
        public Apiextensionsv1beta1Ingress()
        {
            CustomInit();
        }
        ...
        /// More info:
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public Apiextensionsv1beta1Ingress(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Apiextensionsv1beta1IngressSpec spec = default(Apiextensionsv1beta1IngressSpec), Apiextensionsv1beta1IngressStatus status = default(Apiextensionsv1beta1IngressStatus))
        {
        ...
        public Apiextensionsv1beta1IngressSpec Spec { get; set; }
        ...
        public Apiextensionsv1beta1IngressStatus Status { get; set; }
