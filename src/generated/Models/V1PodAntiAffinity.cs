...
namespace k8s.Models
{
    ...
    public partial class V1PodAntiAffinity
    {
        ...
        public V1PodAntiAffinity(IList<V1WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution = default(IList<V1WeightedPodAffinityTerm>), IList<V1PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution = default(IList<V1PodAffinityTerm>))
        {
