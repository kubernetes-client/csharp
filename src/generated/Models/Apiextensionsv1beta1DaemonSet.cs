...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1DaemonSet
    {
        /// <summary>
        /// Initializes a new instance of the Apiextensionsv1beta1DaemonSet
        /// class.
        /// </summary>
        public Apiextensionsv1beta1DaemonSet()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public Apiextensionsv1beta1DaemonSet(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Apiextensionsv1beta1DaemonSetSpec spec = default(Apiextensionsv1beta1DaemonSetSpec), Apiextensionsv1beta1DaemonSetStatus status = default(Apiextensionsv1beta1DaemonSetStatus))
        {
        ...
        public Apiextensionsv1beta1DaemonSetSpec Spec { get; set; }
        ...
        public Apiextensionsv1beta1DaemonSetStatus Status { get; set; }
