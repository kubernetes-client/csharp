...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1NodeSystemInfo
    {
        /// <summary>
        /// Initializes a new instance of the Corev1NodeSystemInfo class.
        /// </summary>
        public Corev1NodeSystemInfo()
        {
            CustomInit();
        }
        ...
        public Corev1NodeSystemInfo(string architecture, string bootID, string containerRuntimeVersion, string kernelVersion, string kubeProxyVersion, string kubeletVersion, string machineID, string operatingSystem, string osImage, string systemUUID)
        {
