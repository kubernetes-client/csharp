...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1ObjectFieldSelector
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ObjectFieldSelector class.
        /// </summary>
        public Corev1ObjectFieldSelector()
        {
            CustomInit();
        }
        ...
        public Corev1ObjectFieldSelector(string fieldPath, string apiVersion = default(string))
        {
