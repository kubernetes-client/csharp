...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1ReplicaSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1ReplicaSetStatus class.
        /// </summary>
        public Apiextensionsv1beta1ReplicaSetStatus()
        {
            CustomInit();
        }
        ...
        /// replica set.</param>
        public Apiextensionsv1beta1ReplicaSetStatus(int replicas, int? availableReplicas = default(int?), IList<Apiextensionsv1beta1ReplicaSetCondition> conditions = default(IList<Apiextensionsv1beta1ReplicaSetCondition>), int? fullyLabeledReplicas = default(int?), long? observedGeneration = default(long?), int? readyReplicas = default(int?))
        {
        ...
        public IList<Apiextensionsv1beta1ReplicaSetCondition> Conditions { get; set; }
