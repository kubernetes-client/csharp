...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiautoscalingv1HorizontalPodAutoscalerStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiautoscalingv1HorizontalPodAutoscalerStatus class.
        /// </summary>
        public Apiautoscalingv1HorizontalPodAutoscalerStatus()
        {
            CustomInit();
        }
        ...
        public Apiautoscalingv1HorizontalPodAutoscalerStatus(int currentReplicas, int desiredReplicas, int? currentCPUUtilizationPercentage = default(int?), System.DateTime? lastScaleTime = default(System.DateTime?), long? observedGeneration = default(long?))
        {
