...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1Secret
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Secret class.
        /// </summary>
        public Corev1Secret()
        {
            CustomInit();
        ...
        /// secret data.</param>
        public Corev1Secret(string apiVersion = default(string), IDictionary<string, byte[]> data = default(IDictionary<string, byte[]>), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IDictionary<string, string> stringData = default(IDictionary<string, string>), string type = default(string))
        {
