...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1SupplementalGroupsStrategyOptions
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiextensionsv1beta1SupplementalGroupsStrategyOptions class.
        /// </summary>
        public Apiextensionsv1beta1SupplementalGroupsStrategyOptions()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1SupplementalGroupsStrategyOptions(IList<Apiextensionsv1beta1IDRange> ranges = default(IList<Apiextensionsv1beta1IDRange>), string rule = default(string))
        {
            Ranges = ranges;
            Rule = rule;
            CustomInit();
        ...
        public IList<Apiextensionsv1beta1IDRange> Ranges { get; set; }
