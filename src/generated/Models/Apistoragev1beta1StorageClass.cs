...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apistoragev1beta1StorageClass
    {
        /// <summary>
        /// Initializes a new instance of the Apistoragev1beta1StorageClass
        /// class.
        /// </summary>
        public Apistoragev1beta1StorageClass()
        {
            CustomInit();
        }
        ...
        public Apistoragev1beta1StorageClass(string provisioner, bool? allowVolumeExpansion = default(bool?), string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IList<string> mountOptions = default(IList<string>), IDictionary<string, string> parameters = default(IDictionary<string, string>), string reclaimPolicy = default(string))
        {
