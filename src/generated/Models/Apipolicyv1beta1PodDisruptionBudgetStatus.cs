...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apipolicyv1beta1PodDisruptionBudgetStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apipolicyv1beta1PodDisruptionBudgetStatus class.
        /// </summary>
        public Apipolicyv1beta1PodDisruptionBudgetStatus()
        {
            CustomInit();
        }
        ...
        public Apipolicyv1beta1PodDisruptionBudgetStatus(int currentHealthy, int desiredHealthy, IDictionary<string, System.DateTime?> disruptedPods, int disruptionsAllowed, int expectedPods, long? observedGeneration = default(long?))
        {
