...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1FlockerVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1FlockerVolumeSource class.
        /// </summary>
        public Corev1FlockerVolumeSource()
        {
            CustomInit();
        }
        ...
        public Corev1FlockerVolumeSource(string datasetName = default(string), string datasetUUID = default(string))
        {
