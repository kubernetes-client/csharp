...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiappsv1beta1StatefulSetStatus
    {
        /// <summary>
        /// Initializes a new instance of the Apiappsv1beta1StatefulSetStatus
        /// class.
        /// </summary>
        public Apiappsv1beta1StatefulSetStatus()
        {
            CustomInit();
        }
        ...
        public Apiappsv1beta1StatefulSetStatus(int replicas, int? collisionCount = default(int?), int? currentReplicas = default(int?), string currentRevision = default(string), long? observedGeneration = default(long?), int? readyReplicas = default(int?), string updateRevision = default(string), int? updatedReplicas = default(int?))
        {
