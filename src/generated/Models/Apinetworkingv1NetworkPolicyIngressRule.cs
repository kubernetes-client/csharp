...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apinetworkingv1NetworkPolicyIngressRule
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apinetworkingv1NetworkPolicyIngressRule class.
        /// </summary>
        public Apinetworkingv1NetworkPolicyIngressRule()
        {
            CustomInit();
        }
        ...
        /// in the list.</param>
        public Apinetworkingv1NetworkPolicyIngressRule(IList<Apinetworkingv1NetworkPolicyPeer> fromProperty = default(IList<Apinetworkingv1NetworkPolicyPeer>), IList<Apinetworkingv1NetworkPolicyPort> ports = default(IList<Apinetworkingv1NetworkPolicyPort>))
        {
        ...
        public IList<Apinetworkingv1NetworkPolicyPeer> FromProperty { get; set; }
