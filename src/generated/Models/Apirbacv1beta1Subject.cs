...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1beta1Subject
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1beta1Subject class.
        /// </summary>
        public Apirbacv1beta1Subject()
        {
            CustomInit();
        }
        ...
        /// error.</param>
        public Apirbacv1beta1Subject(string kind, string name, string apiGroup = default(string), string namespaceProperty = default(string))
        {
            ApiGroup = apiGroup;
            Kind = kind;
            Name = name;
