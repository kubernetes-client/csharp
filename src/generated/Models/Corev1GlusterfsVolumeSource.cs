...
namespace k8s.Models
{
    ...
    /// relabeling.
    /// </summary>
    public partial class Corev1GlusterfsVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1GlusterfsVolumeSource
        /// class.
        /// </summary>
        public Corev1GlusterfsVolumeSource()
        {
            CustomInit();
        }
        ...
        /// to false. More info:
        /// https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md#create-a-pod</param>
        public Corev1GlusterfsVolumeSource(string endpoints, string path, bool? readOnlyProperty = default(bool?))
        {
            Endpoints = endpoints;
            Path = path;
