...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1FlexVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1FlexVolumeSource class.
        /// </summary>
        ...
        public Corev1FlexVolumeSource(string driver, string fsType = default(string), IDictionary<string, string> options = default(IDictionary<string, string>), bool? readOnlyProperty = default(bool?), Corev1LocalObjectReference secretRef = default(Corev1LocalObjectReference))
        {
            Driver = driver;
            FsType = fsType;
            Options = options;
