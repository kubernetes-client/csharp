...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1alpha1Role
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1alpha1Role class.
        /// </summary>
        public Apirbacv1alpha1Role()
        {
            CustomInit();
        }
        ...
        public Apirbacv1alpha1Role(IList<Apirbacv1alpha1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
