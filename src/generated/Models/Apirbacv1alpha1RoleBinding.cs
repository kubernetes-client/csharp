...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1alpha1RoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1alpha1RoleBinding class.
        /// </summary>
        public Apirbacv1alpha1RoleBinding()
        {
            CustomInit();
        }
        ...
        public Apirbacv1alpha1RoleBinding(Apirbacv1alpha1RoleRef roleRef, IList<Apirbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
