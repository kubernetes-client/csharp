...
namespace k8s.Models
{
    ...
    /// through the proxy.
    /// </summary>
    public partial class Corev1Service
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Service class.
        /// </summary>
        public Corev1Service()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</param>
        public Corev1Service(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Corev1ServiceSpec spec = default(Corev1ServiceSpec), Corev1ServiceStatus status = default(Corev1ServiceStatus))
        {
        ...
        public Corev1ServiceSpec Spec { get; set; }
        ...
        public Corev1ServiceStatus Status { get; set; }
