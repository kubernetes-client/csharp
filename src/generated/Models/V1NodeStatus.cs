...
namespace k8s.Models
{
    ...
    public partial class V1NodeStatus
    {
        ...
        /// http://releases.k8s.io/HEAD/docs/admin/node.md#node-addresses</param>
        ...
        /// http://releases.k8s.io/HEAD/docs/admin/node.md#node-condition</param>
        ...
        /// node. More info:
        /// http://releases.k8s.io/HEAD/docs/admin/node.md#node-info</param>
        /// <param name="phase">NodePhase is the recently observed lifecycle
        /// phase of the node. More info:
        /// http://releases.k8s.io/HEAD/docs/admin/node.md#node-phase The field
        /// is never populated, and now is deprecated.</param>
        ...
        /// info: http://releases.k8s.io/HEAD/docs/admin/node.md#node-info
        /// </summary>
