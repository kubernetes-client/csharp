...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PhotonPersistentDiskVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Corev1PhotonPersistentDiskVolumeSource class.
        /// </summary>
        public Corev1PhotonPersistentDiskVolumeSource()
        {
            CustomInit();
        }
        ...
        public Corev1PhotonPersistentDiskVolumeSource(string pdID, string fsType = default(string))
        {
            FsType = fsType;
            PdID = pdID;
            CustomInit();
