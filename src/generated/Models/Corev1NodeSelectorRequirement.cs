...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1NodeSelectorRequirement
    {
        /// <summary>
        /// Initializes a new instance of the Corev1NodeSelectorRequirement
        /// class.
        /// </summary>
        public Corev1NodeSelectorRequirement()
        {
            CustomInit();
        }
        ...
        public Corev1NodeSelectorRequirement(string key, string operatorProperty, IList<string> values = default(IList<string>))
        {
            Key = key;
