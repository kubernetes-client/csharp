...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1Taint
    {
        /// <summary>
        /// Initializes a new instance of the Corev1Taint class.
        /// </summary>
        public Corev1Taint()
        {
            CustomInit();
        ...
        /// taint key.</param>
        public Corev1Taint(string effect, string key, System.DateTime? timeAdded = default(System.DateTime?), string value = default(string))
        {
            Effect = effect;
            Key = key;
            TimeAdded = timeAdded;
