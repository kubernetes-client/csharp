...
namespace k8s.Models
{
    ...
    public partial class V1beta1StorageClass
    {
        ...
        /// class.</param>
        public V1beta1StorageClass(string provisioner, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), IDictionary<string, string> parameters = default(IDictionary<string, string>))
        {
