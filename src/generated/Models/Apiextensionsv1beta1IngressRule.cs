...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiextensionsv1beta1IngressRule
    {
        /// <summary>
        /// Initializes a new instance of the Apiextensionsv1beta1IngressRule
        /// class.
        /// </summary>
        public Apiextensionsv1beta1IngressRule()
        {
            CustomInit();
        }
        ...
        public Apiextensionsv1beta1IngressRule(string host = default(string), Apiextensionsv1beta1HTTPIngressRuleValue http = default(Apiextensionsv1beta1HTTPIngressRuleValue))
        {
            Host = host;
            Http = http;
            CustomInit();
        ...
        public Apiextensionsv1beta1HTTPIngressRuleValue Http { get; set; }
