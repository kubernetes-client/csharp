...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1NFSVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1NFSVolumeSource class.
        /// </summary>
        public Corev1NFSVolumeSource()
        {
            CustomInit();
        }
        ...
        /// More info:
        /// https://kubernetes.io/docs/concepts/storage/volumes#nfs</param>
        public Corev1NFSVolumeSource(string path, string server, bool? readOnlyProperty = default(bool?))
        {
            Path = path;
