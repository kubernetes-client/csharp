...
namespace k8s.Models
{
    ...
    public partial class V1Secret
    {
        ...
        /// <param name="data">Data contains the secret data. Each key must be
        /// a valid DNS_SUBDOMAIN or leading dot followed by valid
        /// DNS_SUBDOMAIN. The serialized form of the secret data is a base64
        /// encoded string, representing the arbitrary (possibly non-string)
        ...
        /// <summary>
        /// Gets or sets data contains the secret data. Each key must be a
        /// valid DNS_SUBDOMAIN or leading dot followed by valid DNS_SUBDOMAIN.
