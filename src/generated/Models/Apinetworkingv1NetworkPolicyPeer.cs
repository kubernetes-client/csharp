...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apinetworkingv1NetworkPolicyPeer
    {
        /// <summary>
        /// Initializes a new instance of the Apinetworkingv1NetworkPolicyPeer
        /// class.
        /// </summary>
        public Apinetworkingv1NetworkPolicyPeer()
        {
            CustomInit();
        }
        ...
        public Apinetworkingv1NetworkPolicyPeer(V1IPBlock ipBlock = default(V1IPBlock), V1LabelSelector namespaceSelector = default(V1LabelSelector), V1LabelSelector podSelector = default(V1LabelSelector))
        {
            IpBlock = ipBlock;
