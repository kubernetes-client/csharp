...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1QuobyteVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1QuobyteVolumeSource class.
        /// </summary>
        public Corev1QuobyteVolumeSource()
        {
            CustomInit();
        }
        ...
        public Corev1QuobyteVolumeSource(string registry, string volume, string group = default(string), bool? readOnlyProperty = default(bool?), string user = default(string))
        {
            Group = group;
