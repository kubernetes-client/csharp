...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PodAffinity
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PodAffinity class.
        /// </summary>
        public Corev1PodAffinity()
        {
            CustomInit();
        }
        ...
        public Corev1PodAffinity(IList<Corev1WeightedPodAffinityTerm> preferredDuringSchedulingIgnoredDuringExecution = default(IList<Corev1WeightedPodAffinityTerm>), IList<Corev1PodAffinityTerm> requiredDuringSchedulingIgnoredDuringExecution = default(IList<Corev1PodAffinityTerm>))
        {
