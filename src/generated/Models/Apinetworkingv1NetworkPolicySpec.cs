...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apinetworkingv1NetworkPolicySpec
    {
        /// <summary>
        /// Initializes a new instance of the Apinetworkingv1NetworkPolicySpec
        /// class.
        /// </summary>
        public Apinetworkingv1NetworkPolicySpec()
        {
            CustomInit();
        }
        ...
        /// in 1.8</param>
        public Apinetworkingv1NetworkPolicySpec(V1LabelSelector podSelector, IList<V1NetworkPolicyEgressRule> egress = default(IList<V1NetworkPolicyEgressRule>), IList<Apinetworkingv1NetworkPolicyIngressRule> ingress = default(IList<Apinetworkingv1NetworkPolicyIngressRule>), IList<string> policyTypes = default(IList<string>))
        {
            Egress = egress;
            Ingress = ingress;
        ...
        public IList<Apinetworkingv1NetworkPolicyIngressRule> Ingress { get; set; }
