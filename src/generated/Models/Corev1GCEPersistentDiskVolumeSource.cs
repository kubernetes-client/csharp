...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1GCEPersistentDiskVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Corev1GCEPersistentDiskVolumeSource class.
        /// </summary>
        public Corev1GCEPersistentDiskVolumeSource()
        {
            CustomInit();
        }
        ...
        /// https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk</param>
        public Corev1GCEPersistentDiskVolumeSource(string pdName, string fsType = default(string), int? partition = default(int?), bool? readOnlyProperty = default(bool?))
        {
            FsType = fsType;
            Partition = partition;
            PdName = pdName;
