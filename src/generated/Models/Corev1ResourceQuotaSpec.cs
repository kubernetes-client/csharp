...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1ResourceQuotaSpec
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ResourceQuotaSpec class.
        /// </summary>
        public Corev1ResourceQuotaSpec()
        {
            CustomInit();
        }
        ...
        /// objects.</param>
        public Corev1ResourceQuotaSpec(IDictionary<string, string> hard = default(IDictionary<string, string>), IList<string> scopes = default(IList<string>))
        {
            Hard = hard;
            Scopes = scopes;
            CustomInit();
