...
namespace k8s.Models
{
    ...
    /// point.
    /// </summary>
    public partial class Corev1LoadBalancerIngress
    {
        /// <summary>
        /// Initializes a new instance of the Corev1LoadBalancerIngress class.
        /// </summary>
        public Corev1LoadBalancerIngress()
        {
            CustomInit();
        }
        ...
        public Corev1LoadBalancerIngress(string hostname = default(string), string ip = default(string))
        {
            Hostname = hostname;
            Ip = ip;
            CustomInit();
