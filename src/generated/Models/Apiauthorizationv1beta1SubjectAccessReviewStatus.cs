...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthorizationv1beta1SubjectAccessReviewStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthorizationv1beta1SubjectAccessReviewStatus class.
        /// </summary>
        public Apiauthorizationv1beta1SubjectAccessReviewStatus()
        {
            CustomInit();
        }
        ...
        public Apiauthorizationv1beta1SubjectAccessReviewStatus(bool allowed, string evaluationError = default(string), string reason = default(string))
        {
            Allowed = allowed;
