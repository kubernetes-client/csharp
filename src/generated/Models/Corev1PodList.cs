...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PodList
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PodList class.
        /// </summary>
        public Corev1PodList()
        {
            CustomInit();
        }
        ...
        /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds</param>
        public Corev1PodList(IList<Corev1Pod> items, string apiVersion = default(string), string kind = default(string), V1ListMeta metadata = default(V1ListMeta))
        {
        ...
        public IList<Corev1Pod> Items { get; set; }
