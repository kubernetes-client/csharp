...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1SecretKeySelector
    {
        /// <summary>
        /// Initializes a new instance of the Corev1SecretKeySelector class.
        /// </summary>
        public Corev1SecretKeySelector()
        {
            CustomInit();
        }
        ...
        /// be defined</param>
        public Corev1SecretKeySelector(string key, string name = default(string), bool? optional = default(bool?))
        {
            Key = key;
            Name = name;
            Optional = optional;
