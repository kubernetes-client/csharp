...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1alpha1ClusterRole
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1alpha1ClusterRole class.
        /// </summary>
        public Apirbacv1alpha1ClusterRole()
        {
            CustomInit();
        }
        ...
        public Apirbacv1alpha1ClusterRole(IList<Apirbacv1alpha1PolicyRule> rules, string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta))
        {
        ...
        public IList<Apirbacv1alpha1PolicyRule> Rules { get; set; }
