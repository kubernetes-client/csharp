...
namespace k8s.Models
{
    ...
    /// the default mode.
    /// </summary>
    public partial class Corev1SecretProjection
    {
        /// <summary>
        /// Initializes a new instance of the Corev1SecretProjection class.
        /// </summary>
        public Corev1SecretProjection()
        {
            CustomInit();
        }
        ...
        /// be defined</param>
        public Corev1SecretProjection(IList<Corev1KeyToPath> items = default(IList<Corev1KeyToPath>), string name = default(string), bool? optional = default(bool?))
        {
            Items = items;
            Name = name;
            Optional = optional;
