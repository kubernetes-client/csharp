...
namespace k8s.Models
{
    ...
    /// matches on kind.
    /// </summary>
    public partial class Corev1LimitRangeItem
    {
        /// <summary>
        /// Initializes a new instance of the Corev1LimitRangeItem class.
        /// </summary>
        public Corev1LimitRangeItem()
        {
            CustomInit();
        }
        ...
        /// to.</param>
        public Corev1LimitRangeItem(IDictionary<string, string> defaultProperty = default(IDictionary<string, string>), IDictionary<string, string> defaultRequest = default(IDictionary<string, string>), IDictionary<string, string> max = default(IDictionary<string, string>), IDictionary<string, string> maxLimitRequestRatio = default(IDictionary<string, string>), IDictionary<string, string> min = default(IDictionary<string, string>), string type = default(string))
        {
