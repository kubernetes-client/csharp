...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1PersistentVolumeClaimSpec
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PersistentVolumeClaimSpec
        /// class.
        /// </summary>
        public Corev1PersistentVolumeClaimSpec()
        {
            CustomInit();
        }
        ...
        public Corev1PersistentVolumeClaimSpec(IList<string> accessModes = default(IList<string>), Corev1ResourceRequirements resources = default(Corev1ResourceRequirements), V1LabelSelector selector = default(V1LabelSelector), string storageClassName = default(string), string volumeName = default(string))
        {
