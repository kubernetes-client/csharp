...
namespace k8s.Models
{
    ...
    /// relabeling.
    /// </summary>
    public partial class Corev1ISCSIVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ISCSIVolumeSource class.
        /// </summary>
        public Corev1ISCSIVolumeSource()
        {
            CustomInit();
        }
        ...
        /// authentication</param>
        public Corev1ISCSIVolumeSource(string iqn, int lun, string targetPortal, bool? chapAuthDiscovery = default(bool?), bool? chapAuthSession = default(bool?), string fsType = default(string), string initiatorName = default(string), string iscsiInterface = default(string), IList<string> portals = default(IList<string>), bool? readOnlyProperty = default(bool?), Corev1LocalObjectReference secretRef = default(Corev1LocalObjectReference))
        {
