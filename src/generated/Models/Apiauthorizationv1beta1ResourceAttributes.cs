...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthorizationv1beta1ResourceAttributes
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthorizationv1beta1ResourceAttributes class.
        /// </summary>
        public Apiauthorizationv1beta1ResourceAttributes()
        {
            CustomInit();
        }
        ...
        /// "*" means all.</param>
        public Apiauthorizationv1beta1ResourceAttributes(string group = default(string), string name = default(string), string namespaceProperty = default(string), string resource = default(string), string subresource = default(string), string verb = default(string), string version = default(string))
        {
            Group = group;
            Name = name;
