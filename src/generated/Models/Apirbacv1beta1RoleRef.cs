...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1beta1RoleRef
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1beta1RoleRef class.
        /// </summary>
        public Apirbacv1beta1RoleRef()
        {
            CustomInit();
        }
        ...
        /// referenced</param>
        public Apirbacv1beta1RoleRef(string apiGroup, string kind, string name)
        {
            ApiGroup = apiGroup;
            Kind = kind;
            Name = name;
