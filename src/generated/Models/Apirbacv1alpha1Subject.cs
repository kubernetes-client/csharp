...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apirbacv1alpha1Subject
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1alpha1Subject class.
        /// </summary>
        public Apirbacv1alpha1Subject()
        {
            CustomInit();
        }
        ...
        /// error.</param>
        public Apirbacv1alpha1Subject(string kind, string name, string apiVersion = default(string), string namespaceProperty = default(string))
        {
