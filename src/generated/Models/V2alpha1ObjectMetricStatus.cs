...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class V2alpha1ObjectMetricStatus
    {
        /// <summary>
        /// Initializes a new instance of the V2alpha1ObjectMetricStatus class.
        /// </summary>
        public V2alpha1ObjectMetricStatus()
        {
          CustomInit();
        }
        ...
        /// object.</param>
        public V2alpha1ObjectMetricStatus(string currentValue, string metricName, V2alpha1CrossVersionObjectReference target)
        {
