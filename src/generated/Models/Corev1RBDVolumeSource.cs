...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1RBDVolumeSource
    {
        /// <summary>
        /// Initializes a new instance of the Corev1RBDVolumeSource class.
        /// </summary>
        public Corev1RBDVolumeSource()
        {
            CustomInit();
        }
        ...
        /// info:
        /// https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it</param>
        public Corev1RBDVolumeSource(string image, IList<string> monitors, string fsType = default(string), string keyring = default(string), string pool = default(string), bool? readOnlyProperty = default(bool?), Corev1LocalObjectReference secretRef = default(Corev1LocalObjectReference), string user = default(string))
        {
            FsType = fsType;
            Image = image;
            Keyring = keyring;
