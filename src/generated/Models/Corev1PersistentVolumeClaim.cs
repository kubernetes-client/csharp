...
namespace k8s.Models
{
    ...
    /// volume
    /// </summary>
    public partial class Corev1PersistentVolumeClaim
    {
        /// <summary>
        /// Initializes a new instance of the Corev1PersistentVolumeClaim
        /// class.
        /// </summary>
        public Corev1PersistentVolumeClaim()
        {
            CustomInit();
        }
        ...
        /// info:
        /// https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims</param>
        public Corev1PersistentVolumeClaim(string apiVersion = default(string), string kind = default(string), V1ObjectMeta metadata = default(V1ObjectMeta), Corev1PersistentVolumeClaimSpec spec = default(Corev1PersistentVolumeClaimSpec), Corev1PersistentVolumeClaimStatus status = default(Corev1PersistentVolumeClaimStatus))
        {
        ...
        public Corev1PersistentVolumeClaimSpec Spec { get; set; }
        ...
        public Corev1PersistentVolumeClaimStatus Status { get; set; }
