...
namespace k8s.Models
{
    ...
    /// defined.
    /// </summary>
    public partial class Policyv1beta1HostPortRange
    {
        /// <summary>
        /// Initializes a new instance of the Policyv1beta1HostPortRange class.
        /// </summary>
        public Policyv1beta1HostPortRange()
        {
            CustomInit();
        }
        ...
        public Policyv1beta1HostPortRange(int max, int min)
        {
            Max = max;
            Min = min;
            CustomInit();
