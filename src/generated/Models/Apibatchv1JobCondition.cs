...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apibatchv1JobCondition
    {
        /// <summary>
        /// Initializes a new instance of the Apibatchv1JobCondition class.
        /// </summary>
        public Apibatchv1JobCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public Apibatchv1JobCondition(string status, string type, System.DateTime? lastProbeTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
