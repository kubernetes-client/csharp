...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Corev1NodeCondition
    {
        /// <summary>
        /// Initializes a new instance of the Corev1NodeCondition class.
        /// </summary>
        public Corev1NodeCondition()
        {
            CustomInit();
        }
        ...
        /// transition.</param>
        public Corev1NodeCondition(string status, string type, System.DateTime? lastHeartbeatTime = default(System.DateTime?), System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
