...
namespace k8s.Models
{
    ...
    public partial class V1NodeSpec
    {
        ...
        /// info:
        /// http://releases.k8s.io/HEAD/docs/admin/node.md#manual-node-administration</param>
        public V1NodeSpec(string externalID = default(string), string podCIDR = default(string), string providerID = default(string), IList<V1Taint> taints = default(IList<V1Taint>), bool? unschedulable = default(bool?))
        {
