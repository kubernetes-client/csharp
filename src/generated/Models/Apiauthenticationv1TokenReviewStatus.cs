...
namespace k8s.Models
{
    ...
    /// </summary>
    public partial class Apiauthenticationv1TokenReviewStatus
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Apiauthenticationv1TokenReviewStatus class.
        /// </summary>
        public Apiauthenticationv1TokenReviewStatus()
        {
            CustomInit();
        }
        ...
        public Apiauthenticationv1TokenReviewStatus(bool? authenticated = default(bool?), string error = default(string), Apiauthenticationv1UserInfo user = default(Apiauthenticationv1UserInfo))
        {
        ...
        public Apiauthenticationv1UserInfo User { get; set; }
