...
namespace k8s.Models
{
    ...
    /// their output format
    /// </summary>
    public partial class Corev1ResourceFieldSelector
    {
        /// <summary>
        /// Initializes a new instance of the Corev1ResourceFieldSelector
        /// class.
        /// </summary>
        public Corev1ResourceFieldSelector()
        {
            CustomInit();
        }
        ...
        public Corev1ResourceFieldSelector(string resource, string containerName = default(string), string divisor = default(string))
        {
