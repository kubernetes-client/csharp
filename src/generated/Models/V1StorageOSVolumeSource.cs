...
namespace k8s.Models
{
    ...
    public partial class V1StorageOSVolumeSource
    {
        ...
        /// created.</param>
        public V1StorageOSVolumeSource(string fsType = default(string), bool? readOnlyProperty = default(bool?), V1LocalObjectReference secretRef = default(V1LocalObjectReference), string volumeName = default(string), string volumeNamespace = default(string))
        {
            FsType = fsType;
