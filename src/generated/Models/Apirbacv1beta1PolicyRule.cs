...
namespace k8s.Models
{
    ...
    /// the rule applies to.
    /// </summary>
    public partial class Apirbacv1beta1PolicyRule
    {
        /// <summary>
        /// Initializes a new instance of the Apirbacv1beta1PolicyRule class.
        /// </summary>
        public Apirbacv1beta1PolicyRule()
        {
            CustomInit();
        }
        ...
        public Apirbacv1beta1PolicyRule(IList<string> verbs, IList<string> apiGroups = default(IList<string>), IList<string> nonResourceURLs = default(IList<string>), IList<string> resourceNames = default(IList<string>), IList<string> resources = default(IList<string>))
        {
            ApiGroups = apiGroups;
